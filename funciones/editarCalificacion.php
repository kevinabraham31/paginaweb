...
<br> <br>
<form action='editarCalificacion.php?id=$id' method='POST' >
    <center>
     <fieldset style='width: 250px; background-color: rgba(38, 13, 231, 0.8); padding: 20px; border-radius: 10px;'>
     <legend style='color: #303030; font-size: 20px; font-weight: bold;' class='titulo'>EDITAR CALIFICACIÓN</legend>
            ...
            <div class='cont__btn'>
                ...
                <a class='btn btn__registros' href='CalificaciónAlumnado.php'>CANCELAR</a>
            </div>
        </fieldset>
    </center>
</form>
...
if (isset($_POST['modificar'])) {
    ...
    if (mysqli_query($conexion, $consultaActualizar)) {
        echo '<script>alert("Registro actualizado correctamente."); window.location.href = "CalificaciónAlumnado.php";</script>';
        exit;
    } else {
