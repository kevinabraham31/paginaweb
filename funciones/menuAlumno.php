...
<body>
    <table border='0' width='100%' align='center'> 
        <tr class='menu'>
            <th width='20%'> <a href='InicioAlumno2.php?id=$id' target='info'>  <h3>INICIO</h3> </a> </th>
            <th width='20%'> <a href='PerfilAlumno.php?id=$id' target='info'>  <h3>PERFIL</h3> </a> </th>
            <th width='20%'> <a href='CursosAlumno.php?id=$id' target='info'> <h3> CURSOS</h3> </a></th>
